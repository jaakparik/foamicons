...
/**
 * @component @name TriangleDownDuotone
 ...
 * @see https://foamicons.com/icons/triangle-down-duotone
 *
 ...
 */
export const TriangleDownDuotone = createFoamicon('TriangleDownDuotone', __iconNode);
