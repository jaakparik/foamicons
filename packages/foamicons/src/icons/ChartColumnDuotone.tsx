...
/**
 * @component @name ChartColumnDuotone
 ...
 * @see https://foamicons.com/icons/chart-column-duotone
 *
 ...
 */
export const ChartColumnDuotone = createFoamicon('ChartColumnDuotone', __iconNode);
