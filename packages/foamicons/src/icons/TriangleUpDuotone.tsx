...
/**
 * @component @name TriangleUpDuotone
 ...
 * @see https://foamicons.com/icons/triangle-up-duotone
 *
 ...
 */
export const TriangleUpDuotone = createFoamicon('TriangleUpDuotone', __iconNode);
