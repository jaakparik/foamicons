...
/**
 * @component @name ArrowUpLeftDuotone
 ...
 * @see https://foamicons.com/icons/arrow-up-left-duotone
 *
 ...
 */
export const ArrowUpLeftDuotone = createFoamicon('ArrowUpLeftDuotone', __iconNode);
