...
/**
 * @component @name TriangleDownFill
 ...
 * @see https://foamicons.com/icons/triangle-down-fill
 *
 ...
 */
export const TriangleDownFill = createFoamicon('TriangleDownFill', __iconNode);
