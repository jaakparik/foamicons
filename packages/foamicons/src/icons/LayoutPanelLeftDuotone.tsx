...
/**
 * @component @name LayoutPanelLeftDuotone
 ...
 * @see https://foamicons.com/icons/layout-panel-left-duotone
 *
 ...
 */
export const LayoutPanelLeftDuotone = createFoamicon('LayoutPanelLeftDuotone', __iconNode);
