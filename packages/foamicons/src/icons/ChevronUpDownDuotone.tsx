...
/**
 * @component @name ChevronUpDownDuotone
 ...
 * @see https://foamicons.com/icons/chevron-up-down-duotone
 *
 ...
 */
export const ChevronUpDownDuotone = createFoamicon('ChevronUpDownDuotone', __iconNode);
