...
/**
 * @component @name UserArrowOutUpRightFill
 ...
 * @see https://foamicons.com/icons/user-arrow-out-up-right-fill
 *
 ...
 */
export const UserArrowOutUpRightFill = createFoamicon('UserArrowOutUpRightFill', __iconNode);
