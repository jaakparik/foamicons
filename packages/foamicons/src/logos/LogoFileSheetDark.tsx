...
/**
 * @component @name LogoFileSheetDark
 ...
 * @see https://foamicons.com/logos/logo-file-sheet-dark
 *
 * @param {object} props - Icon props extending SVGProps<SVGSVGElement>
 * @param {number | string} [props.size=16] - Logo size (width and height)
 * @returns {React.ReactElement} SVG logo element
 */
export const LogoFileSheetDark = createFoamicon('LogoFileSheetDark', __iconNode);
